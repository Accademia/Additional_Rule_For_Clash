...
#
#	-  Geosite:cn 中，有超过 25%的规则是错误规则 ，总数占6800个分流规则中的1700个是错误规则。
#	-  Geosite:cn 中，有超过 19%的规则是冗余的（都是cn后缀域名） ，总数占6800个分流规则中的1400个是错误规则。
#	也就是说，接近 46%的规则（接近3100条规则）是错误的、冗余的，是需要被删除（被注释）的！
#   
#	目前整理后，规则总数：3675个 ：2025-12-03
#	
#
# 引用范例 ：
#
