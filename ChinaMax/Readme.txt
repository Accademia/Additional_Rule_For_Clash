...
5. 同时满足 以下条件的域名，是否应该被收录到 🇨🇳 “中国域名”分流规则中 ？
   条件 1 ： 域名是 ip归属地🇨🇳中国
   条件 2 ： 域名是 非 .us \ .hk \ .tw 等 其它国家地区等级域名
   条件 3 ： 域名是 非 带有 -us-west \ .eu.east. \ oversea  等，带有 地理位置的 域名、cdn域名
...
- 修正后的GeositeCN = 类别 5  （ 精度 100% 正确 ） 全部条件 ✅

- 修正后的ChinaMax（本规则集） =  没有满足 类别5 中的全部条件 ❕❕❕ 
    - ⚠️ 条件1 ：准确度 = 99.9%。 有少量漏网的境外IP域名 
    - ✅ 条件2 ：准确度 = 100%
    - ❌ 条件3 ：未处理
    - ❌ 条件4 ：未处理
