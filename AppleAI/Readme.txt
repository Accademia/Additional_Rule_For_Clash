...
# 注意：
#    ⚠️ 对🇨🇳国行iOS（iPhone、iPad），无需尝试！设备已被苹果锁死。
#
...
# 第1、2把锁 ：通过 enableAppleAI 脚本 可以解除 （ 移步：https://github.com/kanshurichard/enableAppleAI ）
# 第3把锁 ：通过 系统设置，可以解除 
# 第4把锁 ：通过 分流规则，可以解除，

############ 2 ############
# 针对 🇺🇸🇯🇵🇭🇰🇹🇼🇨🇦🇪🇺 等 全球的 非国行 （iPhone、iPad、Mac）：
...
#        ⚠️ 🇺🇸🇯🇵🇭🇰🇹🇼🇨🇦🇪🇺 非国行 mac、iPhone、iPad，无需 这一步操作
