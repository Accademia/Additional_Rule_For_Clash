...
#  注意： 
#    > 运行脚本前，必须关闭SIP，运行后可重新开启
#    > 每次大版本升级（如v26 -> v27 ），未来可能需要重新跑一遍本脚本（目前不需要）
#    > 🇺🇸🇯🇵🇭🇰🇹🇼🇨🇦🇪🇺 非国行 mac、iPhone、iPad，无需 任何脚本操作
...
################################################################
#
#   >  检查点 1 : 在 浏览器 + ChatGPT APP 中，你能不能正常 登录、访问？
#
#   >  检查点 2 : 苹果智能与ChatGPT不同。其大量使用了Quic。所以你还要检查：
#              *  你的VPN，支持不支持Quic？不支持，则无法连接。
#              *  你的VPN，是否使用了链式代理？链式代理会导致Quic失败。
#
