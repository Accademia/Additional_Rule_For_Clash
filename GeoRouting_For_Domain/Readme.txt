...
#
#
#   ccTLD_America_North_Domain                     : {type: http, behavior: domain    , interval: 86400, url: 'https://cdn.jsdelivr.net/gh/Accademia/Additional_Rule_For_Clash@master/GeoRouting_For_Domain/ccTLD_America_North_Domain.yaml'                    , path: ./ruleset/ccTLD_America_North_Domain.yaml                     }
#   ccTLD_America_South_Domain                     : {type: http, behavior: domain    , interval: 86400, url: 'https://cdn.jsdelivr.net/gh/Accademia/Additional_Rule_For_Clash@master/GeoRouting_For_Domain/ccTLD_America_South_Domain.yaml'                    , path: ./ruleset/ccTLD_America_South_Domain.yaml                     }
#   ccTLD_Europe_West_Domain                       : {type: http, behavior: domain    , interval: 86400, url: 'https://cdn.jsdelivr.net/gh/Accademia/Additional_Rule_For_Clash@master/GeoRouting_For_Domain/ccTLD_Europe_West_Domain.yaml'                      , path: ./ruleset/ccTLD_Europe_West_Domain.yaml                       }
#   ccTLD_Europe_East_Domain                       : {type: http, behavior: domain    , interval: 86400, url: 'https://cdn.jsdelivr.net/gh/Accademia/Additional_Rule_For_Clash@master/GeoRouting_For_Domain/ccTLD_Europe_East_Domain.yaml'                      , path: ./ruleset/ccTLD_Europe_East_Domain.yaml                       }
#   ccTLD_Oceania_Domain                           : {type: http, behavior: domain    , interval: 86400, url: 'https://cdn.jsdelivr.net/gh/Accademia/Additional_Rule_For_Clash@master/GeoRouting_For_Domain/ccTLD_Oceania_Domain.yaml'                          , path: ./ruleset/ccTLD_Oceania_Domain.yaml                           }
#   ccTLD_Antarctica_Domain                        : {type: http, behavior: domain    , interval: 86400, url: 'https://cdn.jsdelivr.net/gh/Accademia/Additional_Rule_For_Clash@master/GeoRouting_For_Domain/ccTLD_Antarctica_Domain.yaml'                       , path: ./ruleset/ccTLD_Antarctica_Domain.yaml                        }
#   ccTLD_Asia_East_Domain                         : {type: http, behavior: domain    , interval: 86400, url: 'https://cdn.jsdelivr.net/gh/Accademia/Additional_Rule_For_Clash@master/GeoRouting_For_Domain/ccTLD_Asia_East_Domain.yaml'                        , path: ./ruleset/ccTLD_Asia_East_Domain.yaml                         }
#   ccTLD_Asia_EastSouth_Domain                    : {type: http, behavior: domain    , interval: 86400, url: 'https://cdn.jsdelivr.net/gh/Accademia/Additional_Rule_For_Clash@master/GeoRouting_For_Domain/ccTLD_Asia_EastSouth_Domain.yaml'                   , path: ./ruleset/ccTLD_Asia_EastSouth_Domain.yaml                    }
#   ccTLD_Asia_South_Domain                        : {type: http, behavior: domain    , interval: 86400, url: 'https://cdn.jsdelivr.net/gh/Accademia/Additional_Rule_For_Clash@master/GeoRouting_For_Domain/ccTLD_Asia_South_Domain.yaml'                       , path: ./ruleset/ccTLD_Asia_South_Domain.yaml                        }
#   ccTLD_Asia_Central_Domain                      : {type: http, behavior: domain    , interval: 86400, url: 'https://cdn.jsdelivr.net/gh/Accademia/Additional_Rule_For_Clash@master/GeoRouting_For_Domain/ccTLD_Asia_Central_Domain.yaml'                     , path: ./ruleset/ccTLD_Asia_Central_Domain.yaml                      }
#   ccTLD_Asia_West_Domain                         : {type: http, behavior: domain    , interval: 86400, url: 'https://cdn.jsdelivr.net/gh/Accademia/Additional_Rule_For_Clash@master/GeoRouting_For_Domain/ccTLD_Asia_West_Domain.yaml'                        , path: ./ruleset/ccTLD_Asia_West_Domain.yaml                         }
#   ccTLD_Africa_North_Domain                      : {type: http, behavior: domain    , interval: 86400, url: 'https://cdn.jsdelivr.net/gh/Accademia/Additional_Rule_For_Clash@master/GeoRouting_For_Domain/ccTLD_Africa_North_Domain.yaml'                     , path: ./ruleset/ccTLD_Africa_North_Domain.yaml                      }
#   ccTLD_Africa_South_Domain                      : {type: http, behavior: domain    , interval: 86400, url: 'https://cdn.jsdelivr.net/gh/Accademia/Additional_Rule_For_Clash@master/GeoRouting_For_Domain/ccTLD_Africa_South_Domain.yaml'                     , path: ./ruleset/ccTLD_Africa_South_Domain.yaml                      }
#   ccTLD_Africa_West_Domain                       : {type: http, behavior: domain    , interval: 86400, url: 'https://cdn.jsdelivr.net/gh/Accademia/Additional_Rule_For_Clash@master/GeoRouting_For_Domain/ccTLD_Africa_West_Domain.yaml'                      , path: ./ruleset/ccTLD_Africa_West_Domain.yaml                       }
#   ccTLD_Africa_East_Domain                       : {type: http, behavior: domain    , interval: 86400, url: 'https://cdn.jsdelivr.net/gh/Accademia/Additional_Rule_For_Clash@master/GeoRouting_For_Domain/ccTLD_Africa_East_Domain.yaml'                      , path: ./ruleset/ccTLD_Africa_East_Domain.yaml                       }
#   ccTLD_Africa_Central_Domain                    : {type: http, behavior: domain    , interval: 86400, url: 'https://cdn.jsdelivr.net/gh/Accademia/Additional_Rule_For_Clash@master/GeoRouting_For_Domain/ccTLD_Africa_Central_Domain.yaml'                   , path: ./ruleset/ccTLD_Africa_Central_Domain.yaml                    }
#
